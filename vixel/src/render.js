...
const createAtmosphereRenderer = require("./atmo");
...
module.exports = function Renderer(canvas) {
  ...
  const cmdSample = regl({
    vert: require("./glsl/sample.vert"),
    frag: require("./glsl/sample.frag"),
    attributes: {
      position: ndcBox
    },
    uniforms: {
  ...
  const cmdDisplay = regl({
    vert: require("./glsl/display.vert"),
    frag: require("./glsl/display.frag"),
    attributes: {
      position: ndcBox
    },
    uniforms: {
